 ...
 */
public class ForgetPassword1Activity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    Handler mHandler1 = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if ("OK".equals(msg.obj.toString())){
                //成功代码
                Intent intent = new Intent(ForgetPassword1Activity.this, ForgetPassword2Activity.class);  //进入主界面
                ...
                mNumberView.setError(getString(R.string.error_invalid_internet));
                mEmailSignInButton.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        attemptLogin();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user=intent.getStringExtra("extra_data");
        init();
    }
...
//        }
        ...
        if (TextUtils.isEmpty(number)) {
            mNumberView.setError(getString(R.string.error_number_required));
            focusView = mNumberView;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            params.put(User.NUMBER, mNumberView.getText().toString());
            params.put(User.STATUS,"4");
            try {
                //构造完整URL
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                ...
                Uri.withAppendedPath(ContactsContract.Profile.CONTENT_URI,
                        ContactsContract.Contacts.Data.CONTENT_DIRECTORY), ForgetPassword1Activity.ProfileQuery.PROJECTION,
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        while (!cursor.isAfterLast()) {
            emails.add(cursor.getString(ForgetPassword1Activity.ProfileQuery.ADDRESS));
            cursor.moveToNext();
        }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(ForgetPassword1Activity.this,
