 ...
 */
public class ForgetPassword2Activity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    Handler mHandler1 = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if ("OK".equals(msg.obj.toString())){
                ...
                mPasswordView.setError("修改失败，请重试");
                ...
                mPasswordView.setError(getString(R.string.error_invalid_internet));
                mEmailSignInButton.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        attemptLogin();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number=intent.getStringExtra("extra_pw");
        // Set up the login form.
        mPasswordView1 = (AutoCompleteTextView) findViewById(R.id.confirm_password);
    ...
    private void attemptLogin() {
        ...
        String confirmpassword = mPasswordView1.getText().toString();
        ...
        if (TextUtils.isEmpty(password)) {
            ...
            mPasswordView.setError("密码长度不得小于8位");
            focusView = mPasswordView;
            cancel = true;
        }else if (!password.equals(confirmpassword)) {
            mPasswordView1.setError("密码不一致");
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(ForgetPassword2Activity.this,
                        android.R.layout.simple_dropdown_item_1line, emailAddressCollection);

        mPasswordView.setAdapter(adapter);
    }
